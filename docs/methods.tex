...
\begin{figure}[!ht]
  ...
  \caption{Monthly means in months of maximum fire of each framework input \hlb{add units} and GFEDv4 mean maximum monthly burnt area.}
...
\begin{figure}[!ht]
  ...
  \caption{Monthly means in months of maximum fire of each control. \hlb{add units?}}
