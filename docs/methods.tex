...
\begin{figure}[!ht]
  ...
  \caption{Monthly means of each framework input \hlb{add units} and GFEDv4.}
...
\begin{figure}[!ht]
  ...
  \caption{Monthly means during the fire season for each input \hlb{add units} and GFEDv4 training data. ``Fire season'' is defined as the month with heighest burnt area, calculated each year.}
...
\begin{figure}[!ht]
  ...
  \caption{Monthly means of each control. \hlb{add units?}}
...
\begin{figure}[!ht]
  ...
  \caption{Monthly means of each control during the fire season. \hlb{add units?}}
