...
\begin{frame}<1-5>[label=framework]
    \frametitle{Fire limitation framework}
    \framesubtitle{Spatial and Temporal controls on fire frequency}
    ...
    \begin{tikzpicture}
        ...
        \visible<2>{
            ...
            \node (note) at (0,-1.5em) {\large Atomsphere};
        }
...
\def \controlsSide#1 {
    \begin{textblock*}{11cm}(0.5cm,1.5cm)
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {
                \includegraphics[width=11.0cm]{images/#1}
            };
            \visible<-2> {\draw[white, fill = white] (5.5,3.0) -- (12.0,3.0) -- (12.0,5.9) -- (5.5,5.9) -- (5.5,3.0);}
            \visible<-1> {\draw[white, fill = white] (0.0,0.0) -- ( 5.5,0.0) -- ( 5.5,3.0) -- (0.0,3.0) -- (0.0,0.0);}
            \visible<-2> {\draw[white, fill = white] (5.5,3.0) -- (12.0,3.0) -- (12.0,0.0) -- (5.5,0.0) -- (5.5,3.0);}
            %\visible<-4> {\draw[white, fill = white] (0.0,0) -- (12.0,0) -- (12.0,1.0) -- (0.0,1.0) -- (0.0,0);}
        \end{tikzpicture}
    \end{textblock*}
    \begin{textblock*}{11cm}(2.0cm, 6.5cm)
        \includegraphics[width=6.0cm]{images/#1_legend}
    \end{textblock*}
}

\begin{frame}<1-2>[label=controlMapsNoLand]
