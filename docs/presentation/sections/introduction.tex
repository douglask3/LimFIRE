...
\begin{frame}[label = intro]
	...
	\begin{itemize}
		\large{
			\visible<1->{\item \hspace{2.39em} What controls fire outside of tropical savanna?}
			\visible<2->{\item How much is people, how much is vegetation and how much is climate?}
			\visible<3->{\item \hspace{0.70em} How sensitive is fire to changes in these controls?}
			\visible<3->{\item \hspace{0.70em} Are there detectable trends in controls?}
		}
	\end{itemize}
