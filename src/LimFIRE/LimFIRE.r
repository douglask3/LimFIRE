...
LimFIRE.fuel       <- function(...)   f1(..., force_one = 10000)
imFIRE.moisture   <- function(...) 1-f1(..., force_one =     1)
LimFIRE.ignitions  <- function(...)   f1(..., force_one =   100)
LimFIRE.supression <- function(...) 1-f1(..., force_one =   100)
