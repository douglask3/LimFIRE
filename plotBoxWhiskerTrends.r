...
legLabs = c('Burnt Area', 'All Controls', 'Fuel'   , 'Moisture', ' Ignitions', 'Suppression', 'Fire Regime')
...
addLegend <- function() {
	...
	addAxisLab <- function(y, lab) {
		...
		axis(4, at = y, labels = lab, tick = FALSE, cex.axis = 0.75, las = 1, col = "#FFFFFF00", line = -0.9)
	}
	addAxisLab(-0.9, '10%')
	addAxisLab(-0.4, '25%')
